...
public class defaultPrompter {
    ...
    public String headerReturn() {
        return "    <!--Default Header -->\n"
                ...
                + "            <p id=\"header_banner_p\" style=\"background-color: #D9D9D9; width: 100%;  height: 100%; text-align:center;\">we treat your petto as ours!</p>\n"
                + "        </div>\n"
                + "        <nav>\n"
                + "            <ul>\n"
                ...
                + "                <li><form method=\"post\" action=\"ViewCart\"><input type=\"submit\" value=\"cart\" style=\"border: none; background-color: white; color: black; \"></form></li>\n"
                + "                <li><form method=\"post\" action=\"ViewProfile\"><input type=\"submit\" value=\"profile\" style=\"border: none; background-color: white; color: black; \"></form></li>\n"
                + "        </nav>\n"
                + "    </header>";
    }
