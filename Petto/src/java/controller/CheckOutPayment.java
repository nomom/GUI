...
public class CheckOutPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CheckOutPayment</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CheckOutPayment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("payment").equals("COD")) {
            ...
            paymentList.add(request.getParameter("cardnum"));
            paymentList.add(request.getParameter("cardmonth"));
            paymentList.add(request.getParameter("cardyear"));
            paymentList.add(request.getParameter("ccv"));
        }
